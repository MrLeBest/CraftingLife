...
public class GuiCreativeAdv extends InventoryEffectRenderer
{
    ...
    public GuiCreativeAdv(EntityPlayer p_i1088_1_)
    {
        super(new GuiCreativeAdv.ContainerCreative(p_i1088_1_));
        ...
        else
        {
            ...
            else
            {
                ...
                if (selectedTabIndex == CreativeTabs.tabInventory.getTabIndex())
                {
                    ...
                    {
                        this.mc.thePlayer.inventoryContainer.slotClick(p_146984_1_ == null ? p_146984_2_ : ((GuiCreativeAdv.CreativeSlot)p_146984_1_).field_148332_b.slotNumber, p_146984_3_, p_146984_4_, this.mc.thePlayer);
                ...
                else
                {
                    ...
                    if (Container.func_94532_c(p_146984_3_) == 2)
                    {
                        for (l = 0; l < 6; ++l)
                        {
                            this.mc.playerController.sendSlotPacket(this.inventorySlots.getSlot(45 + l).getStack(), 4 + l);
                        }
                    }
                    else if (p_146984_1_ != null)
                    {
                        itemstack = this.inventorySlots.getSlot(p_146984_1_.slotNumber).getStack();
                        this.mc.playerController.sendSlotPacket(itemstack, p_146984_1_.slotNumber - this.inventorySlots.inventorySlots.size() + 10);
                    }
                }
            }
        }
    ...
    {
        GuiCreativeAdv.ContainerCreative containercreative = (GuiCreativeAdv.ContainerCreative)this.inventorySlots;
    ...
    private void updateFilteredItems(GuiCreativeAdv.ContainerCreative containercreative)
    {
        Iterator iterator;
    ...
    private boolean needsScrollBars()
    {
        ...
        return selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && CreativeTabs.creativeTabArray[selectedTabIndex].shouldHidePlayerInventory() && ((GuiCreativeAdv.ContainerCreative)this.inventorySlots).func_148328_e();
    }
    ...
    private void setCurrentCreativeTab(CreativeTabs p_147050_1_)
    {
        ...
        if (p_147050_1_ == CreativeTabs.tabInventory)
        {
            ...
            {
                GuiCreativeAdv.CreativeSlot creativeslot = new GuiCreativeAdv.CreativeSlot((Slot)container.inventorySlots.get(j), j);
                ...
                else if (j < container.inventorySlots.size()-1)
                {
                    k = j - 4;
                    l = k % 9;
    ...
    public void handleMouseInput()
    {
        ...
        {
            int j = ((GuiCreativeAdv.ContainerCreative)this.inventorySlots).itemList.size() / 9 - 5 + 1;
            ...
            ((GuiCreativeAdv.ContainerCreative)this.inventorySlots).scrollTo(this.currentScroll);
        }
    }
    ...
    static class ContainerCreative extends Container
        {
            ...
            public ContainerCreative(EntityPlayer p_i1086_1_)
            {
                ...
                for (i = 0; i < 5; ++i)
                {
                    for (int j = 0; j < 9; ++j)
                    {
                        this.addSlotToContainer(new Slot(GuiCreativeAdv.field_147060_v, i * 9 + j, 9 + j * 18, 18 + i * 18));
                    }
                }
            ...
            public void scrollTo(float p_148329_1_)
            {
                ...
                for (int k = 0; k < 5; ++k)
                {
                    for (int l = 0; l < 9; ++l)
                    {
                        ...
                        {
                            GuiCreativeAdv.field_147060_v.setInventorySlotContents(l + k * 9, (ItemStack)this.itemList.get(i1));
                        }
                        else
                        {
                            GuiCreativeAdv.field_147060_v.setInventorySlotContents(l + k * 9, (ItemStack)null);
                        }
                    }
                }
            }

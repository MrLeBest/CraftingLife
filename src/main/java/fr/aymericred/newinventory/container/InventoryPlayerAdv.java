...
public class InventoryPlayerAdv extends InventoryPlayer
{
	...
	public InventoryPlayerAdv(EntityPlayer player, InventoryPlayer old)
	{
		super(player);
		mainInventory = new ItemStack[6];
		if(old != null)
		{
			currentItem = old.currentItem;
			setItemStack(old.getItemStack());
			int i=0;
			for(ItemStack ol : old.armorInventory)
			{
				armorInventory[i] = ol;
				i++;
			}
			i=0;
			for(ItemStack ol : old.mainInventory)
			{
				mainInventory[i] = ol;
				i++;
    ...
    {
        return this.currentItem < 6 && this.currentItem >= 0 ? this.mainInventory[this.currentItem] : null;
    }
    ...
    public void changeCurrentItem(int p_70453_1_)
    {
        ...
        for (this.currentItem -= p_70453_1_; this.currentItem < 0; this.currentItem += 6)
        {
            ;
        }
    ...
    public ItemStack getStackInSlotOnClosing(int p_70304_1_)
    {
        ...
        {
        	if(p_70304_1_ > getSizeInventory())
    ...
    public void setInventorySlotContents(int p_70299_1_, ItemStack p_70299_2_)
    {
        ...
        if(p_70299_1_ >= mainInventory.length)
        {
        	if(p_70299_1_ > getSizeInventory())
        		return; //Optimize
        }
    ...
    public NBTTagList writeToNBT(NBTTagList p_70442_1_)
    {
        ...
        if(currentBag != null)
        {
	        ...
	        tag.setByte("Slot", (byte) 200);
	        currentBag.writeToNBT(tag);
	        p_70442_1_.appendTag(tag);
        }
    ...
    public void readFromNBT(NBTTagList p_70443_1_)
    {
        ...
        int i;
        for (i = 0; i < p_70443_1_.tagCount(); ++i)
        {
    ...
    public ItemStack getStackInSlot(int p_70301_1_)
    {
        ...
        if(p_70301_1_ >= mainInventory.length)
        {
        	if(p_70301_1_ > getSizeInventory())
        		return null;
        }
    ...
    public void copyInventory(InventoryPlayer p_70455_1_)
    {
        ...
        if(p_70455_1_ instanceof InventoryPlayerAdv)
        	this.currentBag = ((InventoryPlayerAdv) p_70455_1_).currentBag;
    }
}

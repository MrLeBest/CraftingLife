...
public class TileEntityCameraSpecialRenderer extends TileEntitySpecialRenderer
{
    public static ModelCamera model = new ModelCamera();
    public static ResourceLocation texture = new ResourceLocation("craftingmod:textures/models/blocks/model_camera.png");

...
public class TileEntityCocaSpecialRenderer extends TileEntitySpecialRenderer
{
    public static ModelDistributeur model = new ModelDistributeur();
    public static ResourceLocation texture = new ResourceLocation("craftingmod:textures/models/blocks/model_coca.png");

    @Override
    public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialRenderTick)
    {
        this.renderTileEntityCocaAt((TileEntityCoca)tile, x, y, z, partialRenderTick); 
    }

    private void renderTileEntityCocaAt(TileEntityCoca tile, double x, double y, double z, float partialRenderTick) 
    {

...
public class TileEntityBarrierSpecialRenderer extends TileEntitySpecialRenderer
{
    public static ModelBarriere model = new ModelBarriere();
    public static ResourceLocation texture = new ResourceLocation("craftingmod:textures/models/blocks/model_barriere.png");

    @Override
    public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialRenderTick)
    {
        this.renderTileEntityBarrierAt((TileEntityBarrier)tile, x, y, z, partialRenderTick); 
    }

    private void renderTileEntityBarrierAt(TileEntityBarrier tile, double x, double y, double z, float partialRenderTick) 
    {

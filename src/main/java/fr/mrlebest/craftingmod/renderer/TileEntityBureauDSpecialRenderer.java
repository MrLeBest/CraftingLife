...
public class TileEntityBureauDSpecialRenderer extends TileEntitySpecialRenderer
{
    public static ModelBureauD model = new ModelBureauD();
    public static ResourceLocation texture = new ResourceLocation("craftingmod:textures/models/blocks/model_bureauD.png");

    @Override
    public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialRenderTick)
    {
        this.renderTileEntityBureauDAt((TileEntityBureauD)tile, x, y, z, partialRenderTick); 
    }

    private void renderTileEntityBureauDAt(TileEntityBureauD tile, double x, double y, double z, float partialRenderTick) 
    {

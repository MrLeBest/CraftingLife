...
public class TileEntityAerationSpecialRenderer extends TileEntitySpecialRenderer
{
    public static ModelAeration model = new ModelAeration();
    public static ResourceLocation texture = new ResourceLocation("craftingmod:textures/models/blocks/model_aeration.png");

    @Override
    public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialRenderTick)
    {
        this.renderTileEntityAerationAt((TileEntityAeration)tile, x, y, z, partialRenderTick); 
    }

    private void renderTileEntityAerationAt(TileEntityAeration tile, double x, double y, double z, float partialRenderTick) 
    {

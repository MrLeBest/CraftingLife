...
public class TileEntityFootSpecialRenderer extends TileEntitySpecialRenderer
{
    public static ModelFoot model = new ModelFoot();
    public static ResourceLocation texture = new ResourceLocation("craftingmod:textures/models/blocks/model_foot.png");

    @Override
    public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialRenderTick)
    {
        this.renderTileEntityFootAt((TileEntityFoot)tile, x, y, z, partialRenderTick); 
    }

    private void renderTileEntityFootAt(TileEntityFoot tile, double x, double y, double z, float partialRenderTick) 
    {

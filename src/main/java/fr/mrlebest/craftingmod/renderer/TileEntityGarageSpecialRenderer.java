...
public class TileEntityGarageSpecialRenderer extends TileEntitySpecialRenderer
{
    public static ModelGarage model = new ModelGarage();
    public static ResourceLocation texture = new ResourceLocation("craftingmod:textures/models/blocks/model_garage.png");

    @Override
    public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialRenderTick)
    {
        this.renderTileEntityGarageAt((TileEntityGarage)tile, x, y, z, partialRenderTick); 
    }

    private void renderTileEntityGarageAt(TileEntityGarage tile, double x, double y, double z, float partialRenderTick) 
    {

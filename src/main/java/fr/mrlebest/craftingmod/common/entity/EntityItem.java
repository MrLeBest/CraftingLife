...
public class EntityItem extends Entity
{
    ...
    public EntityItem(World p_i1709_1_, double p_i1709_2_, double p_i1709_4_, double p_i1709_6_)
    {
        ...
        this.randomRotation = this.rand.nextInt(90)+1;
    }

    public EntityItem(World p_i1710_1_,ItemStack p_i1710_8_)
    {
        this(p_i1710_1_);        
    ...
    public boolean interactFirst(EntityPlayer p_130002_1_) {
        if(!this.worldObj.isRemote && this.getEntityItem() != null && p_130002_1_.inventory.addItemStackToInventory(getEntityItem()))
        {
            //System.out.println(getEntityItem());
            this.setEntityItemStack(null);
            this.setDead();
        }
        return true;
    }

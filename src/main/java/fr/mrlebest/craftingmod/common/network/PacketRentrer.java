...
public class PacketRentrer extends PacketBase
{
            ...
            for(Object o : vehicles)
            {
                for(int k = 0; k < TileEntityGarage.lastsVehicle.size(); k++)
                {
                    ...
                    if(o instanceof EntityVehicle)
                    {
                        ...
                        {
                            if(vehicle.getVehicleType().shortName.equals(TileEntityGarage.lastsVehicle.get(k)))
                            {
                                TileEntityGarage.lastsVehicle.remove(vehicle.getVehicleType().shortName);

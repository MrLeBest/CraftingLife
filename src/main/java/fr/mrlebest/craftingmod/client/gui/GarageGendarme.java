...
import fr.mrlebest.craftingmod.common.network.PacketRentrerGendarme;
...
public class GarageGendarme extends GuiScreen
{
    ...
    public GarageGendarme(EntityPlayer ep)
    {
        this.playerEntity = ep;
        this.mc = Minecraft.getMinecraft();
        this.garage = ExtPropCraftingLife.get(ep);
        System.out.println(ep);
        System.out.println(garage.vehiculeGendarme.size());
    }
    ...
    public void initGui()
    {
        ...
        for(int i = 0; i < garage.vehiculeGendarme.size(); i++) // Pour chaque v�hicule

        {
            String vehic = garage.vehiculeGendarme.get(i);
            this.buttonList.add(bouttonVehicle = new GuiBouton(i + 100, this.width / 2 - 100, this.height / 2 - 60 + i * 20, 60, 20, vehic));
        }
    ...
    protected void actionPerformed(GuiButton button)
    {
       ...
       if(button.id >= 100) // Les boutons de v�hicules
        {
        ...
        switch(button.id)
        {
            ...
            case 52:
                ...
                FlansMod.packetHandler.sendToServer(new PacketRentrerGendarme());
                garage.vehiculeGendarme.remove(nomveh);
                break;
    ...
    public void drawScreen(int x, int y, float f)
    {
        ...
        drawString(mc.fontRenderer, StringUtils.abbreviate("Garage Gendarmerie", 20), X, Y+51, 0xFFFFFF);

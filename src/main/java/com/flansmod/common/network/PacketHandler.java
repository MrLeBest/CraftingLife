...
import fr.mrlebest.craftingmod.common.network.PacketVerfication;
...
public class PacketHandler extends MessageToMessageCodec<FMLProxyPacket, PacketBase>
{
	...
	public void initialise()
	{
	    ...
	    registerPacket(PacketLock.class);
	    registerPacket(PacketGuiPolice.class);
	    registerPacket(PacketKlaxon.class);
	    //registerPacket(PacketGuiConcessionnaire.class);
	    registerPacket(PacketSpawn.class);
	    registerPacket(PacketVerfication.class);
	    registerPacket(PacketRentrer.class);
	    registerPacket(PacketRentrerGendarme.class);
	}

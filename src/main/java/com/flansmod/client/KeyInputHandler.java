...
public class KeyInputHandler
{
    ...
    public static KeyBinding lockKey = new KeyBinding("Verouiller/Deverouiller votre vehicule", Keyboard.KEY_U, "Flan's Mod");
    public static KeyBinding policeKey = new KeyBinding("Interface de police", Keyboard.KEY_P, "Flan's Mod");
    public static KeyBinding klaxonKey = new KeyBinding("Klaxon", Keyboard.KEY_X, "Flan's Mod");
    public static KeyBinding sireneKey = new KeyBinding("Sirene de police", Keyboard.KEY_B, "Flan's Mod");
    public static KeyBinding licenseKey = new KeyBinding("Interface de license", Keyboard.KEY_ESCAPE, "CraftingLife.fr");
    public static KeyBinding animationKey = new KeyBinding("Ouvrir l'interface d'animation", Keyboard.KEY_G, "CraftingLife.fr");
    public static KeyBinding pickUpKey = new KeyBinding("Recupérer un objet", Keyboard.KEY_B, "CraftingLife.fr");
    ...
    public KeyInputHandler()
    {
        ...
        ClientRegistry.registerKeyBinding(policeKey);
        ClientRegistry.registerKeyBinding(klaxonKey);
        ClientRegistry.registerKeyBinding(sireneKey);
        ClientRegistry.registerKeyBinding(licenseKey);
        ClientRegistry.registerKeyBinding(animationKey);
        ClientRegistry.registerKeyBinding(pickUpKey);
    ...
    public void onKeyInput(KeyInputEvent event)
    {
        ...
        if(lockKey.isPressed())
        {
            keyLockTyped();
        }
        if(policeKey.isPressed())
        {
            keyPoliceTyped();
        }
        ...
        if(sireneKey.isPressed())
        {
            keySireneTyped();
        }

        if(licenseKey.isPressed())
        {
            keyLicenseTyped();
        }

        if(animationKey.isPressed())
        {
            keyAnimationTyped();
        }
        
        if(pickUpKey.isPressed())
        {
            keyPickUpTyped();
        }
    ...
    private void keyPickUpTyped()
    {
        
        
    }

    private void keyLicenseTyped()
    {
        EntityPlayer playerEntity = mc.thePlayer;
        mc.displayGuiScreen(new GuiScreenLicense(playerEntity));
    }

    private void keySireneTyped()
    {
        //FlansMod.getPacketHandler().sendToServer(new PacketSirenePolice());
    }

    private void keyPoliceTyped()
    {
        EntityPlayer playerEntity = mc.thePlayer;
        ...
        for(Object o : vehicles)
        {
            ...
            {
                mc.displayGuiScreen(new GuiScreenPolice(playerEntity));
            }
        }
    }

    private void keyKlaxonTyped()
    {}

    private void keyLockTyped()
    {
        FlansMod.getPacketHandler().sendToServer(new PacketLock());
    }
    
    private void keyAnimationTyped() {
        mc.displayGuiScreen(new GuiAnimation());
    }

    ...
    public void render(EntityVehicle vehicle, double d, double d1, double d2, float f, float f1)
    {
        ...
        GL11.glPushMatrix();
        {
            ...
            if(FlansMod.DEBUG)
            {
                ...
                // renderAABB(AxisAlignedBB.getBoundingBox(type.barrelPosition.x - 0.25F, type.barrelPosition.y - 0.25F, type.barrelPosition.z - 0.25F, type.barrelPosition.x + 0.25F,
                // type.barrelPosition.y + 0.25F, type.barrelPosition.z + 0.25F));

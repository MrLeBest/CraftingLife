...
public class GuiDriveableController extends GuiScreen 
{
	...
	protected void keyTyped(char c, int i)
    {
	    ...
	    if (i == KeyInputHandler.lockKey.getKeyCode()) {
	        this.plane.pressKey(20, (EntityPlayer)this.plane.getControllingEntity());
	      }
	      if (i == KeyInputHandler.klaxonKey.getKeyCode()) {
	        this.plane.pressKey(21, (EntityPlayer)this.plane.getControllingEntity());
	      }
	      if (i == KeyInputHandler.sireneKey.getKeyCode()) {
	            this.plane.pressKey(22, (EntityPlayer)this.plane.getControllingEntity());
	      }
    }
